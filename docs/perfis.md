...
Compreenda o seu papel na AIDE. A aplicação foi desenvolvida para dois tipos de utilizadores distintos, cada um com necessidades e objetivos específicos.
...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem', margin: '2rem 0'}}>
  ...
  <div style={{padding: '1.5rem', backgroundColor: '#E8ECFF', borderRadius: '12px', borderLeft: '4px solid #122aff'}}>
    <strong style={{color: '#000746', fontSize: '1.1rem'}}>Para o Cuidado</strong>
    <p style={{margin: '0.75rem 0 0', color: '#333'}}>Mantenha a sua autonomia sabendo que nunca estará verdadeiramente sozinho. Sinta-se seguro com a certeza de que alguém está sempre atento.</p>
  </div>
</div>
...
:::info Tem dúvidas?
Consulte a página de [Perguntas Frequentes](./faq) para respostas às questões mais comuns sobre a AIDE.
:::
